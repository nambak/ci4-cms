        ...
        <div class="container mx-auto px-4 py-12">
            ...
            <div class="flex gap-4 mt-4">
                <a href="https://github.com/nambak/ci4-cms" target="_blank" rel="noopener noreferrer"
                   class="text-nord-3 hover:text-nord-6 transition-colors" aria-label="GitHub 저장소 (새 탭에서 열림)">
                ...
                <a href="https://www.linkedin.com/in/nambak80/" target="_blank" rel="noopener noreferrer"
                   class="text-nord-3 hover:text-nord-6 transition-colors" aria-label="LinkedIn 프로필 (새 탭에서 열림)">
                    <svg class="size-5" fill="currentColor" viewBox="0 0 24 24">
