...
<nav class="fixed top-0 w-full z-50 bg-slate-50/70 backdrop-blur-xl shadow-sm">
    <div class="flex justify-between items-center max-w-7xl mx-auto px-6 h-16">
        ...
        <div class="flex items-center gap-4">
            ...
            <a href="/register" class="hero-gradient px-5 py-2.5 text-white font-bold text-sm rounded-xl shadow-lg shadow-primary/20 active:scale-95 transition-all">시작하기</a>
            <!-- Mobile Hamburger -->
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white/95 backdrop-blur-xl border-t border-slate-200/50">
        <div class="max-w-7xl mx-auto px-6 py-4 space-y-2">
            ...
            <a href="/register" class="block py-3 px-4 text-sm font-bold text-white bg-primary rounded-lg text-center">시작하기</a>
        </div>
    </div>
</nav>
        ...
        <div class="max-w-7xl mx-auto grid lg:grid-cols-2 items-center">
            <div class="space-y-8">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="/register" class="hero-gradient px-8 py-4 text-white font-bold rounded-xl shadow-xl shadow-primary/20 hover:opacity-90 transition-all flex items-center gap-2">
                        시작하기 <span class="material-symbols-outlined">arrow_forward</span>
                    </a>
                    <a href="#features" class="bg-surface-container-high text-primary px-8 py-4 font-bold rounded-xl hover:bg-surface-container-highest transition-all">
                        자세히 보기
                    </a>
                </div>
            </div>
    ...
    <section class="bg-surface-container-low py-12 border-y border-outline-variant/10 text-center">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div class="flex flex-col">
                    <span class="text-3xl font-black text-primary">PHP 8.x</span>
                    <span class="font-bold text-on-secondary-container mt-1">최적화 엔진</span>
                </div>
                <div class="flex flex-col">
                    <span class="text-3xl font-black text-primary">RESTful</span>
                    <span class="font-bold text-on-secondary-container mt-1">API 제공</span>
                </div>
                <div class="flex flex-col">
                    <span class="text-3xl font-black text-primary">Zero</span>
    ...
    <section id="features" class="bg-nord-5 py-32 px-6">
        <div class="max-w-7xl mx-auto">
            <div class="mb-20 space-y-4">
                <span class="text-primary font-bold tracking-[0.2em] uppercase text-xs">핵심 기능</span>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group p-8 rounded-xl bg-surface-container-lowest hover:bg-surface-container-highest transition-all duration-300">
                    <div class="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center text-primary mb-6 group-hover:bg-primary group-hover:text-white transition-colors">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="relative flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">
                <div class="z-10 bg-surface-container-lowest p-6 rounded-xl shadow-lg border border-outline-variant/10 w-full md:w-48 text-center group hover:scale-105 transition-transform">
                    <span class="material-symbols-outlined text-primary text-4xl mb-4">person</span>
                    <p class="font-bold uppercase">사용자</p>
                </div>
                <div class="hidden md:block h-px flex-1 bg-gradient-to-r from-primary/40 to-primary/40 mx-2"></div>
                <div class="z-10 bg-surface-container-lowest p-6 rounded-xl shadow-lg border border-outline-variant/10 w-full md:w-48 text-center group hover:scale-105 transition-transform">
                    <span class="material-symbols-outlined text-primary text-4xl mb-4">lock</span>
                    <p class="font-bold uppercase">보안 검사</p>
                </div>
                <div class="hidden md:block h-px flex-1 bg-gradient-to-r from-primary/40 to-primary/40 mx-2"></div>
                <div class="z-10 bg-primary p-6 rounded-xl shadow-xl w-full md:w-48 text-center transform scale-110">
                ...
                <div class="hidden md:block h-px flex-1 bg-gradient-to-r from-primary/40 to-primary/40 mx-2"></div>
                <div class="z-10 bg-surface-container-lowest p-6 rounded-xl shadow-lg border border-outline-variant/10 w-full md:w-48 text-center group hover:scale-105 transition-transform">
                    <span class="material-symbols-outlined text-primary text-4xl mb-4">send</span>
    ...
    <section class="py-32 px-6">
        <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
            <div class="bg-surface-container-highest p-12 rounded-xl relative overflow-hidden group">
                ...
                <span class="text-primary font-bold text-sm block">멀티테넌시 구조</span>
                ...
                <ul class="space-y-3">
                    <li class="flex items-center gap-3 text-sm font-semibold"><span class="material-symbols-outlined text-primary text-sm">check_circle</span> OpenAPI 3.0 문서화</li>
                    <li class="flex items-center gap-3 text-sm font-semibold"><span class="material-symbols-outlined text-primary text-sm">check_circle</span> Bearer Token API 인증</li>
            ...
            <div class="bg-on-background p-12 rounded-xl text-white relative overflow-hidden group">
                ...
                <span class="text-primary font-bold text-sm block">테스트 환경</span>
        ...
        <div class="max-w-5xl mx-auto hero-gradient rounded-3xl p-12 md:p-20 text-center text-white relative overflow-hidden shadow-2xl">
            ...
            <div class="relative z-10 space-y-8">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                    <a href="/register" class="bg-white text-primary px-10 py-5 rounded-xl font-black text-lg hover:bg-slate-50 transition-all shadow-xl">시작하기</a>
                    <a href="/docs/api" class="bg-primary/20 backdrop-blur-md border border-white/20 px-10 py-5 rounded-xl font-black text-lg hover:bg-white/10 transition-all">API 문서 보기</a>
                </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 max-w-7xl mx-auto py-16 px-6">
        <div class="col-span-2 space-y-3">
            ...
            <div class="flex gap-4">
                <a href="https://github.com/nambak/ci4-cms" target="_blank" rel="noopener noreferrer" aria-label="GitHub 저장소" class="text-slate-400 hover:text-primary transition-colors">
                ...
                <a href="https://www.linkedin.com/in/nambak80/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn 프로필" class="text-slate-400 hover:text-primary transition-colors">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                    </svg>
                </a>
                <a href="mailto:nambak80@gmail.com" aria-label="이메일" class="text-slate-400 hover:text-primary transition-colors">
