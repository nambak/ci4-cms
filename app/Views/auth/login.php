                    ...
                    <div class="mb-7">
                        ...
                        <div class="relative">
                            <input
                                ...
                                required
                            >
                            <button type="button" class="absolute right-3 top-1/2 -translate-y-1/2 text-nord-4 opacity-50 hover:opacity-80 transition-opacity" onclick="togglePassword('password', this)" aria-label="비밀번호 표시" aria-pressed="false">
                                <svg class="w-5 h-5 eye-off" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                                </svg>
                                <svg class="w-5 h-5 eye-on hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
